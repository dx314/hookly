...
type CreateEndpointRequest struct {
	...
	Destinations       []*DestinationInput `protobuf:"bytes,6,rep,name=destinations,proto3" json:"destinations,omitempty"`
...
func (x *CreateEndpointRequest) GetDestinations() []*DestinationInput {
	if x != nil {
...
type DestinationInput struct {
	...
	Enabled       *bool                  `protobuf:"varint,3,opt,name=enabled,proto3,oneof" json:"enabled,omitempty"` // Defaults to true
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DestinationInput) Reset() {
	*x = DestinationInput{}
...
func (x *DestinationInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DestinationInput) ProtoMessage() {}

func (x *DestinationInput) ProtoReflect() protoreflect.Message {
	mi := &file_hookly_v1_edge_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DestinationInput.ProtoReflect.Descriptor instead.
func (*DestinationInput) Descriptor() ([]byte, []int) {
	return file_hookly_v1_edge_proto_rawDescGZIP(), []int{1}
}

func (x *DestinationInput) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DestinationInput) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *DestinationInput) GetEnabled() bool {
...
type UpdateEndpointRequest struct {
	...
	DestinationUrl  *string                `protobuf:"bytes,4,opt,name=destination_url,json=destinationUrl,proto3,oneof" json:"destination_url,omitempty"` // Updates the primary destination's URL
	...
	ProviderType  *ProviderType `protobuf:"varint,7,opt,name=provider_type,json=providerType,proto3,enum=hookly.v1.ProviderType,oneof" json:"provider_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateEndpointRequest) GetProviderType() ProviderType {
...
type AddDestinationRequest struct {
	...
	Enabled       *bool                  `protobuf:"varint,4,opt,name=enabled,proto3,oneof" json:"enabled,omitempty"` // Defaults to true
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AddDestinationRequest) GetEndpointId() string {
	if x != nil {
		return x.EndpointId
	}
	return ""
...
func (x *AddDestinationRequest) GetEnabled() bool {
	if x != nil && x.Enabled != nil {
		return *x.Enabled
	}
	return false
...
func (x *AddDestinationResponse) GetDestination() *Destination {
	if x != nil {
...
func (x *AddDestinationResponse) GetEndpoint() *Endpoint {
	if x != nil {
		return x.Endpoint
	}
	return nil
...
func (x *UpdateDestinationResponse) GetEndpoint() *Endpoint {
	if x != nil {
		return x.Endpoint
	}
	return nil
...
func (x *RemoveDestinationRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *RemoveDestinationResponse) GetEndpoint() *Endpoint {
	if x != nil {
		return x.Endpoint
	}
	return nil
...
type ReplayWebhookRequest struct {
	...
	DestinationId *string `protobuf:"bytes,2,opt,name=destination_id,json=destinationId,proto3,oneof" json:"destination_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReplayWebhookRequest) GetDestinationId() string {
...
func (x *GetSettingsResponse) Reset() {
	*x = GetSettingsResponse{}
	mi := &file_hookly_v1_edge_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSettingsResponse) Descriptor() ([]byte, []int) {
	return file_hookly_v1_edge_proto_rawDescGZIP(), []int{26}
}
...
func (x *GetUserSettingsRequest) Reset() {
	*x = GetUserSettingsRequest{}
	mi := &file_hookly_v1_edge_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserSettingsRequest) Descriptor() ([]byte, []int) {
	return file_hookly_v1_edge_proto_rawDescGZIP(), []int{27}
}
...
func (x *GetUserSettingsResponse) Reset() {
	*x = GetUserSettingsResponse{}
	mi := &file_hookly_v1_edge_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserSettingsResponse) Descriptor() ([]byte, []int) {
	return file_hookly_v1_edge_proto_rawDescGZIP(), []int{28}
}
...
func (x *UpdateUserSettingsRequest) Reset() {
	*x = UpdateUserSettingsRequest{}
	mi := &file_hookly_v1_edge_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateUserSettingsRequest) Descriptor() ([]byte, []int) {
	return file_hookly_v1_edge_proto_rawDescGZIP(), []int{29}
}
...
func (x *UpdateUserSettingsResponse) Reset() {
	*x = UpdateUserSettingsResponse{}
	mi := &file_hookly_v1_edge_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateUserSettingsResponse) Descriptor() ([]byte, []int) {
	return file_hookly_v1_edge_proto_rawDescGZIP(), []int{30}
}
...
func (x *GetSystemSettingsRequest) Reset() {
	*x = GetSystemSettingsRequest{}
	mi := &file_hookly_v1_edge_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSystemSettingsRequest) Descriptor() ([]byte, []int) {
	return file_hookly_v1_edge_proto_rawDescGZIP(), []int{31}
}
...
func (x *GetSystemSettingsResponse) Reset() {
	*x = GetSystemSettingsResponse{}
	mi := &file_hookly_v1_edge_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSystemSettingsResponse) Descriptor() ([]byte, []int) {
	return file_hookly_v1_edge_proto_rawDescGZIP(), []int{32}
}
...
const file_hookly_v1_edge_proto_rawDesc = "" +
	"\n" +
	"\x14hookly/v1/edge.proto\x12\thookly.v1\x1a\x16hookly/v1/common.proto\"\xce\x02\n" +
	...
	"\fdestinations\x18\x06 \x03(\v2\x1b.hookly.v1.DestinationInputR\fdestinations\"c\n" +
	"\x10DestinationInput\x12\x12\n" +
	...
	"\x13verification_config\x18\x06 \x01(\v2\x1d.hookly.v1.VerificationConfigR\x12verificationConfig\x12A\n" +
	"\rprovider_type\x18\a \x01(\x0e2\x17.hookly.v1.ProviderTypeH\x04R\fproviderType\x88\x01\x01B\a\n" +
	"\x05_nameB\x13\n" +
	...
	"\x16DeleteEndpointResponse\"\x89\x01\n" +
	"\x15AddDestinationRequest\x12\x1f\n" +
	...
	"\n" +
	"\b_enabled\"\x83\x01\n" +
	"\x16AddDestinationResponse\x128\n" +
	"\vdestination\x18\x01 \x01(\v2\x16.hookly.v1.DestinationR\vdestination\x12/\n" +
	"\bendpoint\x18\x02 \x01(\v2\x13.hookly.v1.EndpointR\bendpoint\"\x96\x01\n" +
	...
	"\n" +
	"\b_enabled\"\x86\x01\n" +
	"\x19UpdateDestinationResponse\x128\n" +
	"\vdestination\x18\x01 \x01(\v2\x16.hookly.v1.DestinationR\vdestination\x12/\n" +
	"\bendpoint\x18\x02 \x01(\v2\x13.hookly.v1.EndpointR\bendpoint\"*\n" +
	"\x18RemoveDestinationRequest\x12\x0e\n" +
	...
	"\x0edestination_id\x18\x02 \x01(\tH\x00R\rdestinationId\x88\x01\x01B\x11\n" +
	...
	"\bsettings\x18\x01 \x01(\v2\x19.hookly.v1.SystemSettingsR\bsettings2\xee\n" +
	"\n" +
	"\vEdgeService\x12U\n" +
	...
	"\x0eDeleteEndpoint\x12 .hookly.v1.DeleteEndpointRequest\x1a!.hookly.v1.DeleteEndpointResponse\x12U\n" +
	"\x0eAddDestination\x12 .hookly.v1.AddDestinationRequest\x1a!.hookly.v1.AddDestinationResponse\x12^\n" +
	"\x11UpdateDestination\x12#.hookly.v1.UpdateDestinationRequest\x1a$.hookly.v1.UpdateDestinationResponse\x12^\n" +
	"\x11RemoveDestination\x12#.hookly.v1.RemoveDestinationRequest\x1a$.hookly.v1.RemoveDestinationResponse\x12I\n" +
	"\n" +
...
var file_hookly_v1_edge_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_hookly_v1_edge_proto_goTypes = []any{
	(*CreateEndpointRequest)(nil),      // 0: hookly.v1.CreateEndpointRequest
	(*DestinationInput)(nil),           // 1: hookly.v1.DestinationInput
	(*CreateEndpointResponse)(nil),     // 2: hookly.v1.CreateEndpointResponse
	(*GetEndpointRequest)(nil),         // 3: hookly.v1.GetEndpointRequest
	(*GetEndpointResponse)(nil),        // 4: hookly.v1.GetEndpointResponse
	(*ListEndpointsRequest)(nil),       // 5: hookly.v1.ListEndpointsRequest
	(*ListEndpointsResponse)(nil),      // 6: hookly.v1.ListEndpointsResponse
	(*UpdateEndpointRequest)(nil),      // 7: hookly.v1.UpdateEndpointRequest
	(*UpdateEndpointResponse)(nil),     // 8: hookly.v1.UpdateEndpointResponse
	(*DeleteEndpointRequest)(nil),      // 9: hookly.v1.DeleteEndpointRequest
	(*DeleteEndpointResponse)(nil),     // 10: hookly.v1.DeleteEndpointResponse
	(*AddDestinationRequest)(nil),      // 11: hookly.v1.AddDestinationRequest
	(*AddDestinationResponse)(nil),     // 12: hookly.v1.AddDestinationResponse
	(*UpdateDestinationRequest)(nil),   // 13: hookly.v1.UpdateDestinationRequest
	(*UpdateDestinationResponse)(nil),  // 14: hookly.v1.UpdateDestinationResponse
	(*RemoveDestinationRequest)(nil),   // 15: hookly.v1.RemoveDestinationRequest
	(*RemoveDestinationResponse)(nil),  // 16: hookly.v1.RemoveDestinationResponse
	(*GetWebhookRequest)(nil),          // 17: hookly.v1.GetWebhookRequest
	(*GetWebhookResponse)(nil),         // 18: hookly.v1.GetWebhookResponse
	(*ListWebhooksRequest)(nil),        // 19: hookly.v1.ListWebhooksRequest
	(*ListWebhooksResponse)(nil),       // 20: hookly.v1.ListWebhooksResponse
	(*ReplayWebhookRequest)(nil),       // 21: hookly.v1.ReplayWebhookRequest
	(*ReplayWebhookResponse)(nil),      // 22: hookly.v1.ReplayWebhookResponse
	(*GetStatusRequest)(nil),           // 23: hookly.v1.GetStatusRequest
	(*GetStatusResponse)(nil),          // 24: hookly.v1.GetStatusResponse
	(*GetSettingsRequest)(nil),         // 25: hookly.v1.GetSettingsRequest
	(*GetSettingsResponse)(nil),        // 26: hookly.v1.GetSettingsResponse
	(*GetUserSettingsRequest)(nil),     // 27: hookly.v1.GetUserSettingsRequest
	(*GetUserSettingsResponse)(nil),    // 28: hookly.v1.GetUserSettingsResponse
	(*UpdateUserSettingsRequest)(nil),  // 29: hookly.v1.UpdateUserSettingsRequest
	(*UpdateUserSettingsResponse)(nil), // 30: hookly.v1.UpdateUserSettingsResponse
	(*GetSystemSettingsRequest)(nil),   // 31: hookly.v1.GetSystemSettingsRequest
	(*GetSystemSettingsResponse)(nil),  // 32: hookly.v1.GetSystemSettingsResponse
	(ProviderType)(0),                  // 33: hookly.v1.ProviderType
	(*VerificationConfig)(nil),         // 34: hookly.v1.VerificationConfig
	(*Endpoint)(nil),                   // 35: hookly.v1.Endpoint
	(*PaginationRequest)(nil),          // 36: hookly.v1.PaginationRequest
	(*PaginationResponse)(nil),         // 37: hookly.v1.PaginationResponse
	(*Destination)(nil),                // 38: hookly.v1.Destination
	(*Webhook)(nil),                    // 39: hookly.v1.Webhook
	(WebhookStatus)(0),                 // 40: hookly.v1.WebhookStatus
	(*SystemStatus)(nil),               // 41: hookly.v1.SystemStatus
	(ThemePreference)(0),               // 42: hookly.v1.ThemePreference
	(*UserSettings)(nil),               // 43: hookly.v1.UserSettings
	(*SystemSettings)(nil),             // 44: hookly.v1.SystemSettings
}
var file_hookly_v1_edge_proto_depIdxs = []int32{
	33, // 0: hookly.v1.CreateEndpointRequest.provider_type:type_name -> hookly.v1.ProviderType
	34, // 1: hookly.v1.CreateEndpointRequest.verification_config:type_name -> hookly.v1.VerificationConfig
	1,  // 2: hookly.v1.CreateEndpointRequest.destinations:type_name -> hookly.v1.DestinationInput
	35, // 3: hookly.v1.CreateEndpointResponse.endpoint:type_name -> hookly.v1.Endpoint
	35, // 4: hookly.v1.GetEndpointResponse.endpoint:type_name -> hookly.v1.Endpoint
	36, // 5: hookly.v1.ListEndpointsRequest.pagination:type_name -> hookly.v1.PaginationRequest
	35, // 6: hookly.v1.ListEndpointsResponse.endpoints:type_name -> hookly.v1.Endpoint
	37, // 7: hookly.v1.ListEndpointsResponse.pagination:type_name -> hookly.v1.PaginationResponse
	34, // 8: hookly.v1.UpdateEndpointRequest.verification_config:type_name -> hookly.v1.VerificationConfig
	33, // 9: hookly.v1.UpdateEndpointRequest.provider_type:type_name -> hookly.v1.ProviderType
	35, // 10: hookly.v1.UpdateEndpointResponse.endpoint:type_name -> hookly.v1.Endpoint
	38, // 11: hookly.v1.AddDestinationResponse.destination:type_name -> hookly.v1.Destination
	35, // 12: hookly.v1.AddDestinationResponse.endpoint:type_name -> hookly.v1.Endpoint
	38, // 13: hookly.v1.UpdateDestinationResponse.destination:type_name -> hookly.v1.Destination
	35, // 14: hookly.v1.UpdateDestinationResponse.endpoint:type_name -> hookly.v1.Endpoint
	35, // 15: hookly.v1.RemoveDestinationResponse.endpoint:type_name -> hookly.v1.Endpoint
	39, // 16: hookly.v1.GetWebhookResponse.webhook:type_name -> hookly.v1.Webhook
	40, // 17: hookly.v1.ListWebhooksRequest.status:type_name -> hookly.v1.WebhookStatus
	36, // 18: hookly.v1.ListWebhooksRequest.pagination:type_name -> hookly.v1.PaginationRequest
	39, // 19: hookly.v1.ListWebhooksResponse.webhooks:type_name -> hookly.v1.Webhook
	37, // 20: hookly.v1.ListWebhooksResponse.pagination:type_name -> hookly.v1.PaginationResponse
	39, // 21: hookly.v1.ReplayWebhookResponse.webhook:type_name -> hookly.v1.Webhook
	41, // 22: hookly.v1.GetStatusResponse.status:type_name -> hookly.v1.SystemStatus
	42, // 23: hookly.v1.GetSettingsResponse.theme_preference:type_name -> hookly.v1.ThemePreference
	43, // 24: hookly.v1.GetUserSettingsResponse.settings:type_name -> hookly.v1.UserSettings
	42, // 25: hookly.v1.UpdateUserSettingsRequest.theme_preference:type_name -> hookly.v1.ThemePreference
	43, // 26: hookly.v1.UpdateUserSettingsResponse.settings:type_name -> hookly.v1.UserSettings
	44, // 27: hookly.v1.GetSystemSettingsResponse.settings:type_name -> hookly.v1.SystemSettings
	0,  // 28: hookly.v1.EdgeService.CreateEndpoint:input_type -> hookly.v1.CreateEndpointRequest
	3,  // 29: hookly.v1.EdgeService.GetEndpoint:input_type -> hookly.v1.GetEndpointRequest
	5,  // 30: hookly.v1.EdgeService.ListEndpoints:input_type -> hookly.v1.ListEndpointsRequest
	7,  // 31: hookly.v1.EdgeService.UpdateEndpoint:input_type -> hookly.v1.UpdateEndpointRequest
	9,  // 32: hookly.v1.EdgeService.DeleteEndpoint:input_type -> hookly.v1.DeleteEndpointRequest
	11, // 33: hookly.v1.EdgeService.AddDestination:input_type -> hookly.v1.AddDestinationRequest
	13, // 34: hookly.v1.EdgeService.UpdateDestination:input_type -> hookly.v1.UpdateDestinationRequest
	15, // 35: hookly.v1.EdgeService.RemoveDestination:input_type -> hookly.v1.RemoveDestinationRequest
	17, // 36: hookly.v1.EdgeService.GetWebhook:input_type -> hookly.v1.GetWebhookRequest
	19, // 37: hookly.v1.EdgeService.ListWebhooks:input_type -> hookly.v1.ListWebhooksRequest
	21, // 38: hookly.v1.EdgeService.ReplayWebhook:input_type -> hookly.v1.ReplayWebhookRequest
	23, // 39: hookly.v1.EdgeService.GetStatus:input_type -> hookly.v1.GetStatusRequest
	25, // 40: hookly.v1.EdgeService.GetSettings:input_type -> hookly.v1.GetSettingsRequest
	27, // 41: hookly.v1.EdgeService.GetUserSettings:input_type -> hookly.v1.GetUserSettingsRequest
	29, // 42: hookly.v1.EdgeService.UpdateUserSettings:input_type -> hookly.v1.UpdateUserSettingsRequest
	31, // 43: hookly.v1.EdgeService.GetSystemSettings:input_type -> hookly.v1.GetSystemSettingsRequest
	2,  // 44: hookly.v1.EdgeService.CreateEndpoint:output_type -> hookly.v1.CreateEndpointResponse
	4,  // 45: hookly.v1.EdgeService.GetEndpoint:output_type -> hookly.v1.GetEndpointResponse
	6,  // 46: hookly.v1.EdgeService.ListEndpoints:output_type -> hookly.v1.ListEndpointsResponse
	8,  // 47: hookly.v1.EdgeService.UpdateEndpoint:output_type -> hookly.v1.UpdateEndpointResponse
	10, // 48: hookly.v1.EdgeService.DeleteEndpoint:output_type -> hookly.v1.DeleteEndpointResponse
	12, // 49: hookly.v1.EdgeService.AddDestination:output_type -> hookly.v1.AddDestinationResponse
	14, // 50: hookly.v1.EdgeService.UpdateDestination:output_type -> hookly.v1.UpdateDestinationResponse
	16, // 51: hookly.v1.EdgeService.RemoveDestination:output_type -> hookly.v1.RemoveDestinationResponse
	18, // 52: hookly.v1.EdgeService.GetWebhook:output_type -> hookly.v1.GetWebhookResponse
	20, // 53: hookly.v1.EdgeService.ListWebhooks:output_type -> hookly.v1.ListWebhooksResponse
	22, // 54: hookly.v1.EdgeService.ReplayWebhook:output_type -> hookly.v1.ReplayWebhookResponse
	24, // 55: hookly.v1.EdgeService.GetStatus:output_type -> hookly.v1.GetStatusResponse
	26, // 56: hookly.v1.EdgeService.GetSettings:output_type -> hookly.v1.GetSettingsResponse
	28, // 57: hookly.v1.EdgeService.GetUserSettings:output_type -> hookly.v1.GetUserSettingsResponse
	30, // 58: hookly.v1.EdgeService.UpdateUserSettings:output_type -> hookly.v1.UpdateUserSettingsResponse
	32, // 59: hookly.v1.EdgeService.GetSystemSettings:output_type -> hookly.v1.GetSystemSettingsResponse
...
func file_hookly_v1_edge_proto_init() {
	...
	file_hookly_v1_edge_proto_msgTypes[1].OneofWrappers = []any{}
	file_hookly_v1_edge_proto_msgTypes[7].OneofWrappers = []any{}
	file_hookly_v1_edge_proto_msgTypes[11].OneofWrappers = []any{}
	file_hookly_v1_edge_proto_msgTypes[13].OneofWrappers = []any{}
	file_hookly_v1_edge_proto_msgTypes[19].OneofWrappers = []any{}
	file_hookly_v1_edge_proto_msgTypes[21].OneofWrappers = []any{}
	file_hookly_v1_edge_proto_msgTypes[29].OneofWrappers = []any{}
	type x struct{}
